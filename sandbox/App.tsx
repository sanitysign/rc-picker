...
const NavIcon = ({ isNext = false }) => {
  return <span className={`rc-picker-nav-icon rc-picker-nav-icon-${isNext ? "next" : "prev"}`}></span>
}

const NavIconSuper = ({ isNext = false }) => {
  return <span className={`rc-picker-nav-icon-super rc-picker-nav-icon-super-${isNext ? "next" : "prev"}`}></span>
}
  ...
  return (
    <span className="rc-picker-suffix-icon">
      <svg width="1em" height="1em" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <path d="M11.1084 1V4.2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M4.89014 1V4.2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path
